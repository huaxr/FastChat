...
# prompt_toolkit 是一个 Python 库，提供了一套用于构建交互式命令行应用程序的工具集。它能够处理各种常见的命令行功能，
# 例如命令补全、多行编辑、历史记录等等，同时提供了可定制的主题和快捷键配置等功能，使得开发交互式命令行应用程序变得更加容易。
# prompt_toolkit 的主要优点是可定制性强，同时也是一个非常流行的命令行界面工具库。
